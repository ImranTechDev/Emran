...
const Header = ({ title, image, type }) => {
  return (
    <div className="w-full h-[100vh]">
      ...
      <div className="absolute w-full h-full bg-gradient-to-t from-black to-transparent top-20 z-8 flex flex-col justify-center items-center pt-8 2xl:pt-20 px-4 ">
        <h1 className="text-white text-4xl  md:text-5xl font-bold text-center">
          {title}
        </h1>
        {type && (
          <p className="text-sm mt-4 text-green-500 bg-[#00000090] px-6 py-4 rounded-full text-center">
